  ...
  constructor(props) {
    ...
    this.state = {
      careers: [
        ...
        {title:'Ambulance(Emergency Medical Technician)', description:'Assess injuries, administer emergency medical care, and extricate trapped individuals. Transport injured or sick persons to medical facilities.', education:'Postsecondary non-degree award', wages:'$18.22 to $29.88', color:'#EA2430'},
        ...
        {title:'', description:'', education:'', wages:'', color:'#57B74F'},
        {title:'', description:'', education:'', wages:'', color:'#57B74F'},
        {title:'', description:'', education:'', wages:'', color:'#57B74F'},
        {title:'', description:'', education:'', wages:'', color:'#57B74F'},
        {title:'', description:'', education:'', wages:'', color:'#57B74F'},
