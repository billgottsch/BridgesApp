  ...
  constructor(props) {
    ...
    this.state = {
      businesses: [
        ...
        {name:'CLC - American Sign Language', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Child Development', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Earth Sciences', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Economics', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Geography', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Global Studies', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - History', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Honors', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - International Students', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Peace Corps', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Philosophy', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - PKE', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Political Science', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Psychology', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Spanish', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Sociology', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
        {name:'CLC - Theatre', address:'501 W College Dr', city:'Brainerd', state:'MN', zip:'56401', phone:'(218) 855-8000', color:'#FFF'},
